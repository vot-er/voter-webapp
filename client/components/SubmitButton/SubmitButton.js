...
export class SubmitButton extends React.Component {
  ...
  getClassName = () => {
    ...
    const buttonStyle = className ? className : "btn btn-primary btn-submit";
  ...
  render() {
    ...
    return (
      ...
      >
        {isSubmitting === true ? (
          <Loader
            className="btn-submit__loader"
            loaded={this.props.isSubmitting === true}
            type="ball-scale-ripple"
          />
        ) : null}
        <span className={`${isSubmitting ? "btn-submit__text--hidden" : ""}`}>
          {this.props.value}
        </span>
      </button>
    );
